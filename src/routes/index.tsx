...
import { ErrorPlaceholder } from '../pages/ErrorPlaceholder';
 ...
 * - Rotas `/error/:code` exibem placeholders temporários (substituídos em #7).
...
export const AppRoutes: React.FC = () => (
  <Routes>
    <Route element={<AppLayout />}>
      ...
      <Route path="/error/:code" element={<ErrorPlaceholder />} />
      <Route path="*" element={<ErrorPlaceholder code="404" />} />
    </Route>
  </Routes>
);
